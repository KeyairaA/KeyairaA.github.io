...
//Screen 13
function Run_M_HeteroHeteroVil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	redCoat.mousePressed(RedEncounter_M_HeteroHeteroVil);
	door.mousePressed(Green2Encounter_M_HeteroHeteroVil);

}

function GreenEncounter_M_HeteroHeteroVil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption = createA('#','Want to Choose another path?');
	firstOption.mousePressed(OneEncounter_M_HeteroHetero_Vil);
...
function startStory_M_Hetero_Villian(){
	...
	firstOption.mousePressed(conStory_M__Villian);
...
function OneEncounter_M_Bi_Villian(){
	...
	secondOption.mousePressed(GreenEncounter_M_BiBi_Villian);
