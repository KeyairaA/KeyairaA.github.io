...
//Woman
//Not
function startStory_N_Homo_Hero(){
	background(0);
	egoInput.hide();
	title1.hide();
	...
	firstOption.mousePressed(conStory_N_Homo_Hero);

}

//Screen 8
//Man
function conStory_N_Homo_Hero(){
	background(0);
	title.hide();
	firstOption.hide()
	...
	firstOption.mousePressed(Stutter_N_Homo_Hero);
	secondOption.mousePressed(Confindently_N_Homo_Hero);

}

//Screen 9
function Stutter_N_Homo_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Pen_N_Homo_Hero);

}

function Confindently_N_Homo_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Pen_N_Homo_Hero(){
	...
	firstOption.mousePressed(OneEncounter_N_Homo_Hero);
	secondOption.mousePressed(OneDead_N_Homo_Hero);
}

//Screen 11
//Man
function OneEncounter_N_Homo_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Run_N_Homo_Hero);
	secondOption.mousePressed(GreenEncounter_N_Homo_Hero);

}

//Screen 12
function OneDead_N_Homo_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Run_N_Homo_Hero(){
	...
	redCoat.mousePressed(RedEncounter_N_Homo_Hero);
	door.mousePressed(Green2Encounter_N_Homo_Hero);

}

function GreenEncounter_N_Homo_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function RedEncounter_N_Homo_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Green2Encounter_N_Homo_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption = createA('#','Want to Choose another path?');
	firstOption.mousePressed(OneEncounter_N_Homo_Vil);

}

//Vil
function startStory_N_Homo_Vil(){
	background(0);
	egoInput.hide();
	title1.hide();
	...
	firstOption.mousePressed(conStory_N_Homo_Vil);

}

function conStory_N_Homo_Vil(){
	background(0);
	title.hide();
	firstOption.hide()
	...
	firstOption.mousePressed(Stutter_N_Homo_Vil);
	secondOption.mousePressed(Confindently_N_Homo_Vil);

}

//Screen 9
function Stutter_N_Homo_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Pen_N_Homo_Vil);

}

function Confindently_N_Homo_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Pen_N_Homo_Vil(){
	...
	firstOption.mousePressed(OneEncounter_N_Homo_Vil);
	secondOption.mousePressed(OneDead_NN_Homo_Vil);
}

//Screen 11
//Man
function OneEncounter_N_Homo_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Run_N_Homo_Vil);
	secondOption.mousePressed(GreenEncounter_N_Homo_Vil);

}

//Screen 12
function OneDead_N_Homo_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Run_N_Homo_Vil(){
	...
	redCoat.mousePressed(RedEncounter_N_Homo_Vil);
	door.mousePressed(Green2Encounter_N_Homo_Vil);

}

function GreenEncounter_N_Homo_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function RedEncounter_N_Homo_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Green2Encounter_N_Homo_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
//Vil
function startStory_N_Homo_Villian(){
	background(0);
	egoInput.hide();
	title1.hide();
	...
	firstOption.mousePressed(conStory_N_Homo_Villian);

}

function conStory_N_Homo_Villian(){
	background(0);
	title.hide();
	firstOption.hide()
	...
	firstOption.mousePressed(Stutter_N_Homo_Villian);
	secondOption.mousePressed(Confindently_N_Homo_Villian);

}

//Screen 9
function Stutter_N_Homo_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Pen_N_Homo_Villian);

}

function Confindently_N_Homo_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Pen_N_Homo_Villian(){
	...
	firstOption.mousePressed(OneEncounter_N_Homo_Villian);
	secondOption.mousePressed(OneDead_N_Homo_Villian);
}

//Screen 11
//Man
function OneEncounter_N_Homo_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Run_N_Homo_Villian);
	secondOption.mousePressed(GreenEncounter_N_Homo_Villian);

}

//Screen 12
function OneDead_N_Homo_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Run_N_Homo_Villian(){
	...
	redCoat.mousePressed(RedEncounter_N_Homo_Villian);
	door.mousePressed(Green2Encounter_N_Homo_Villian);
}

function GreenEncounter_N_Homo_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function RedEncounter_N_Homo_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Green2Encounter_N_Homo_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
//Straight
function startStory_N_Hetero_Hero(){
	background(0);
	egoInput.hide();
	title1.hide();
	...
	firstOption.mousePressed(conStory_N_Hetero_Hero);

}

function conStory_N_Hetero_Hero(){
	background(0);
	title.hide();Hetero
	firstOption.hide()
	...
	firstOption.mousePressed(Stutter_N_Hetero_Hero);
	secondOption.mousePressed(Confindently_N_Hetero_Hero);

}

//Screen 9
function Stutter_N_Hetero_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Pen_N_Hetero_Hero);

}

function Confindently_N_Hetero_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Pen_N_Hetero_Hero(){
	...
	firstOption.mousePressed(OneEncounter_N_Hetero_Hero);
	secondOption.mousePressed(OneDead_N_Hetero_Hero);
}

//Screen 11
//Man
function OneEncounter_N_Hetero_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Run_N_Hetero_Hero);
	secondOption.mousePressed(GreenEncounter_N_Hetero_Hero);

}

//Screen 12
function OneDead_N_Hetero_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Run_N_Hetero_Hero(){
	...
	redCoat.mousePressed(RedEncounter_N_Hetero_Hero);
	door.mousePressed(Green2Encounter_N_Hetero_Hero);

}

function GreenEncounter_N_Hetero_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function RedEncounter_N_Hetero_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Green2Encounter_N_Hetero_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function startStory_N_Hetero_Vil(){
	background(0);
	egoInput.hide();
	title1.hide();
	...
	firstOption.mousePressed(conStory_N_Hetero_Vil);

}

function conStory_N_Hetero_Vil(){
	background(0);
	title.hide();Hetero
	firstOption.hide()
	...
	firstOption.mousePressed(Stutter_N_Hetero_Vil);
	secondOption.mousePressed(Confindently_N_Hetero_Vil);

}

//Screen 9
function Stutter_N_Hetero_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Pen_N_Hetero_Vil);

}

function Confindently_N_Hetero_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Pen_N_Hetero_Vil(){
	...
	firstOption.mousePressed(OneEncounter_N_Hetero_Vil);
	secondOption.mousePressed(OneDead_N_Hetero_Vil);
}

//Screen 11
//Man
function OneEncounter_N_Hetero_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Run_N_Hetero_Vil);
	secondOption.mousePressed(GreenEncounter_N_Hetero_Vil);

}

//Screen 12
function OneDead_N_Hetero_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Run_N_Hetero_Vil(){
	...
	redCoat.mousePressed(RedEncounter_N_Hetero_Vil);
	door.mousePressed(Green2Encounter_N_Hetero_Vil);

}

function GreenEncounter_N_Hetero_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function RedEncounter_N_Hetero_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Green2Encounter_N_Hetero_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
//Villian
function startStory_N_Hetero_Villian(){
	background(0);
	egoInput.hide();
	title1.hide();
	...
	firstOption.mousePressed(conStory_N_Hetero_Villian);

}

function conStory_N_Hetero_Villian(){
	background(0);
	title.hide();
	firstOption.hide()
	...
	firstOption.mousePressed(Stutter_N_Hetero_Villian);
	secondOption.mousePressed(Confindently_N_Hetero_Villian);

}

//Screen 9
function Stutter_N_Hetero_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Pen_N_Hetero_Villian);

}

function Confindently_N_Hetero_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
//Screen 10
//Man
function Pen_NN_Hetero_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(OneEncounter_N_Hetero_Villian);
	secondOption.mousePressed(OneDead_N_Hetero_Villian);
}

//Screen 11
//Man
function OneEncounter_N_Hetero_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Run_NN_Hetero_Villian);
	secondOption.mousePressed(GreenEncounter_NN_Hetero_Villian);

}

//Screen 12
function OneDead_N_Hetero_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Run_N_Hetero_Villian(){
	...
	redCoat.mousePressed(RedEncounter_N_Hetero_Villian);
	door.mousePressed(Green2Encounter_N_Hetero_Villian);

}

function GreenEncounter_N_Hetero_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function RedEncounter_N_Hetero_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Green2Encounter_N_Hetero_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function startStory_N_Bi_Hero(){
	...
	firstOption.mousePressed(conStory_N_Bi_Hero);

}

function conStory_N_Bi_Hero(){
	background(0);
	title.hide();
	firstOption.hide()
	...
	firstOption.mousePressed(Stutter_N_Bi_Hero);
	secondOption.mousePressed(Confindently_N_Bi_Hero);

}

//Screen 9
function Stutter_N_Bi_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Pen_N_Bi_Hero);

}

function Confindently_N_Bi_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Pen_N_Bi_Hero(){
	...
	firstOption.mousePressed(OneEncounter_N_Bi_Hero);
	secondOption.mousePressed(OneDead_N_Bi_Hero);
}

//Screen 11
//Man
function OneEncounter_N_Bi_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Run_N_Bi_Hero);
	secondOption.mousePressed(GreenEncounter_N_Bi_Hero);

}

//Screen 12
function OneDead_N_Bi_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Run_N_Bi_Hero(){
	...
	redCoat.mousePressed(RedEncounter_N_Bi_Hero);
	door.mousePressed(Green2Encounter_N_Bi_Hero);

}

function GreenEncounter_N_Bi_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function RedEncounter_N_Bi_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Green2Encounter_N_Bi_Hero(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function startStory_N_Bi_Vil(){
	...
	firstOption.mousePressed(conStory_N_Bi_Vil);

}

function conStory_N_Bi_Vil(){
	background(0);
	title.hide();
	firstOption.hide()
	...
	firstOption.mousePressed(Stutter_N_Bi_Vil);
	secondOption.mousePressed(Confindently_N_Bi_Vil);

}

//Screen 9
function Stutter_N_Bi_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Pen_N_Bi_Vil);

}

function Confindently_N_Bi_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Pen_N_Bi_Vil(){
	...
	firstOption.mousePressed(OneEncounter_N_Bi_Vil);
	secondOption.mousePressed(OneDead_N_Bi_Vil);
}

//Screen 11
//Man
function OneEncounter_N_Bi_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Run_N_Bi_Vil);
	secondOption.mousePressed(GreenEncounter_N_Bi_Vil);

}

//Screen 12
function OneDead_N_Bi_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Run_N_Bi_Vil(){
	...
	redCoat.mousePressed(RedEncounter_N_Bi_Vil);
	door.mousePressed(Green2Encounter_N_Bi_Vil);

}

function GreenEncounter_N_Bi_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function RedEncounter_N_Bi_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Green2Encounter_N_Bi_Vil(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
//Vil
function startStory_N_Bi_Villian(){
	background(0);
	egoInput.hide();
	title1.hide();
	...
	firstOption.mousePressed(conStory_N_Bi_Villian);

}

function conStory_N_Bi_Villian(){
	background(0);
	title.hide();
	firstOption.hide()
	...
	firstOption.mousePressed(Stutter_N_Bi_Villian);
	secondOption.mousePressed(Confindently_N_Bi_Villian);

}

//Screen 9
function Stutter_N_Bi_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Pen_N_Bi_Villian);

}

function Confindently_N_Bi_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Pen_N_Bi_Villian(){
	...
	firstOption.mousePressed(OneEncounter_N_Bi_Villian);
	secondOption.mousePressed(OneDead_N_BiVillian);
}

//Screen 11
//Man
function OneEncounter_N_Bi_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
	...
	firstOption.mousePressed(Run_N_Bi_Villian);
	secondOption.mousePressed(GreenEncounter_N_Bi_Villian);

}

//Screen 12
function OneDead_N_Bi_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Run_N_Bi_Villian(){
	...
	redCoat.mousePressed(RedEncounter_N_Bi_Villian);
	door.mousePressed(Green2Encounter_N_Bi_Villian);

}

function GreenEncounter_N_Bi_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function RedEncounter_N_Bi_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
...
function Green2Encounter_N_Bi_Villian(){
	background(0);
	title.hide();
	title1.hide();
	firstOption.hide();
